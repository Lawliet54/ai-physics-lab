...
function FormulaShell({ children, className = "", style = {} }) {
  return (
    <div className={`inline-flex items-center justify-center gap-1.5 font-black tracking-[-0.03em] ${className}`.trim()} style={style}>
      {children}
    </div>
  );
}
    ...
    case "F = k|q₁q₂| / r²":
      return (
        <FormulaShell className={className} style={style}>
          <span style={darkText}>F</span>
          <span style={darkText}>= k</span>
