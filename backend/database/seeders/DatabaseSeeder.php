...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $theories = [
            ['TH-01', 'electric-charge', 'electrostatics', 'Электр заряды', 'q = n * e', 'Элементар заряд ұғымы, зарядтың сақталу заңы және зарядталған денелердің қасиеттері.', 'basic'],
            ['TH-02', 'coulomb-law', 'electrostatics', 'Кулон заңы', 'F = k|q1q2| / r^2', 'Екі нүктелік заряд арасындағы электростатикалық өзара әрекеттесу күшін сипаттайтын заң.', 'intermediate'],
            ['TH-03', 'electric-field', 'electrostatics', 'Электр өрісі', 'E = F / q = kQ / r^2', 'Электр өрісінің кернеулігі, өріс сызықтары және суперпозиция принципі.', 'intermediate'],
            ['TH-04', 'electric-potential', 'electrostatics', 'Электр потенциалы', 'phi = W / q = kQ / r', 'Потенциал және потенциалдар айырмасы, эквипотенциалды беттер мен жұмыс байланысы.', 'intermediate'],
            ['TH-05', 'capacitors', 'electrostatics', 'Конденсаторлар', 'C = Q / U = epsilon0 epsilon S / d', 'Электр сыйымдылығы, жазық конденсатор, диэлектриктер мен энергия жинақтау.', 'intermediate'],
            ['TH-06', 'ohms-law', 'circuits', 'Ом заңы', 'I = U / R', 'Тізбек бөлігі үшін Ом заңы, кедергі ұғымы және вольт-амперлік сипаттама.', 'basic'],
            ['TH-07', 'kirchhoff-laws', 'circuits', 'Кирхгоф ережелері', 'sum I = 0; sum U = sum EMF', 'Тізбек торабындағы токтар мен ілмектегі кернеулер үшін Кирхгоф ережелері.', 'advanced'],
            ['TH-08', 'electric-power', 'circuits', 'Ток жұмысы мен қуаты', 'P = UI = I^2R = U^2/R', 'Электр тогының атқаратын жұмысы, қуаты және Джоуль-Ленц заңы.', 'intermediate'],
            ['TH-09', 'magnetic-field', 'magnetism', 'Магнит өрісі', 'B = mu0 I / 2 pi r', 'Тогы бар өткізгіш тудыратын магнит өрісі, индукция векторы және магнит ағыны.', 'intermediate'],
            ['TH-10', 'ampere-force', 'magnetism', 'Ампер күші', 'F = BIL sin(alpha)', 'Магнит өрісіндегі токты өткізгішке әсер ететін күш.', 'intermediate'],
            ['TH-11', 'lorentz-force', 'magnetism', 'Лоренц күші', 'F = qvB sin(alpha)', 'Магнит өрісінде қозғалатын зарядқа әсер ететін Лоренц күші.', 'advanced'],
            ['TH-12', 'electromagnetic-induction', 'induction', 'Электромагниттік индукция', 'epsilon = -Delta Phi / Delta t', 'Фарадей заңы, индукциялық ЭҚК, Ленц ережесі және өздік индукция.', 'advanced'],
        ];
